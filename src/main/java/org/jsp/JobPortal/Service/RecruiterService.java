...
public class RecruiterService 
{
	...
	public String scheduleInterview(int id, LocalDateTime interviewDate, ModelMap map, HttpSession session, Recruiter recruiter) 
	{
		...
		else 
		{
			...
			notification.setMessage("Interview Schedule On :" + interviewDate + " for the Company :"+ application.getJob().getRecruiter().getCompanyname());
