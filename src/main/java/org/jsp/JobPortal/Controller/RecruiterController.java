...
public class RecruiterController 
{
    ...
    @GetMapping("/signup")
    public String loadRecruiterSignup()
    {
	...
	public String scheduleInterview(HttpSession session, ModelMap map, @RequestParam int id, @RequestParam LocalDateTime interviewDate)
	{
		Recruiter recruiter = (Recruiter) session.getAttribute("recruiter");
		if (recruiter == null) 
		{
